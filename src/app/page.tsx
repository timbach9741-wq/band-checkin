    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-indigo-200">
      ...
      <main className="flex flex-col items-center">
        ...
        <section className="w-full px-4 -mt-10 relative z-20">
          <div className="max-w-3xl mx-auto bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-6 md:p-10">
            ...
            <div className="flex flex-col gap-6 max-w-2xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {Object.entries(platformLabels).map(([key, label]) => (
                    <button
                      ...
                      className={`py-4 px-3 rounded-2xl font-bold text-sm md:text-base border-2 transition-all duration-200 ${
                        newPlatform === key 
              ...
              <div className="space-y-3">
                ...
                <input 
                  ...
                  placeholder="예: 서초동 조기축구회, 강남 맘카페" 
                ...
                <div className="space-y-6 max-w-2xl mx-auto">
                  ...
                  <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                    <p className="text-indigo-600 font-bold mb-3 flex items-center gap-2">
                      ✅ 회원 참여용 출석체크 링크 <span className="text-slate-400 font-medium text-sm">(공지사항 등록용)</span>
                    </p>
                  ...
                  <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
                    ...
                    <p className="text-pink-600 font-bold mb-3 flex items-center gap-2 ml-2">
                      👑 방장님 전용 관리자 링크 <span className="text-red-500 font-bold text-sm bg-red-50 px-2 py-0.5 rounded border border-red-100">(초기비밀번호: 1234)</span>
                    </p>
                    ...
                    <div className="mt-4 p-3 bg-pink-50 rounded-xl border border-pink-100 ml-2">
                      <p className="text-xs text-pink-700 font-bold flex items-start gap-1">
                        <span className="text-base leading-none">💡</span> 
                        이 링크로 들어가시면 매월 달성자 명단을 엑셀로 뽑을 수 있습니다. 유출되지 않게 방장님만 보관하세요!
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="w-full bg-white py-24 px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-500 font-medium">출석체크만 있는 게 아닙니다. 매일매일 들어오게 만드는 마법 같은 기능들!</p>
            </div>
        ...
        <footer className="w-full bg-slate-900 text-slate-400 py-12 text-center border-t border-slate-800">
          <div className="max-w-5xl mx-auto px-4 font-medium text-sm">
            <p>Community Booster - 모임 활성화를 위한 최고의 선택</p>
            <p className="mt-2 text-slate-500">본 서비스는 커뮤니티 방장님들을 위해 100% 무료로 제공되며, 경품 비용 등은 스폰서 제휴 마케팅 수수료로 충당됩니다.</p>
